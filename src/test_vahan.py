...
def test_vahan():
    ...
    logger.info("Starting VAHAN test run...")
    
    try:
        year = 2024
        logger.info(f"Phase 1: Fetching Bronze data for {year}...")
        fetch_results = connector.fetch(year=year)
        ...
        logger.info("VAHAN test run COMPLETED.")
